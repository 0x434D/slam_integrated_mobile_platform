...
data_GNSS_Sim = simulateGNSS(data_IP,[-0.011 0.134 0.202], additionalRot);
...
for i=1800:10:8000 %size(data_GNSS_Sim,1)
    ...
    cart= R(1:2,1:2,i)*additionalRot(1:2,1:2) *cart;
    cart=cart';
    cart=cart+data_IP(i,2:3);
    
    wheel1= R(1:2,1:2,i)*additionalRot(1:2,1:2) *wheel1;
    wheel1=wheel1';
    wheel1=wheel1+data_IP(i,2:3);
    
    wheel2= R(1:2,1:2,i)*additionalRot(1:2,1:2) *wheel2;
    wheel2=wheel2';
    wheel2=wheel2+data_IP(i,2:3);
    
    wheel3= R(1:2,1:2,i)*additionalRot(1:2,1:2) *wheel3;
    wheel3=wheel3';
    wheel3=wheel3+data_IP(i,2:3);
    
    wheel4= R(1:2,1:2,i)*additionalRot(1:2,1:2) *wheel4;
    wheel4=wheel4';
    wheel4=wheel4+data_IP(i,2:3);
    
    xQuat=R(:,:,i) * additionalRot * xQuat;
    xQuat=xQuat(1:2,1:2)';
    xQuat=xQuat+data_IP(i,2:3);
    
    yQuat=R(:,:,i) * additionalRot *yQuat;
    yQuat=yQuat(1:2,1:2)';
