...
function [traj_GNSS] = simulateGNSS(traj_scan, leverArm, additionalRot, dir)
...
% Rotate lever arm and add to scanner position
for i=1:size(traj_scan,1)
    switch dat_type
        case 'mat'
            ...
            switch dir
                case 1
                    leverArm_i = additionalRot*rotMat* leverArm;
                case 2
                    leverArm_i = rotMat*additionalRot* leverArm;
            end
